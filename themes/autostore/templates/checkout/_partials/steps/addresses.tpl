...
{block name='step_content'}
  <div class="js-address-form">
    ...
    >
      ...
      {if !$use_same_address}
        <h2 class="h4">{l s='Billing & Shipping Address' d='Shop.Theme.Checkout'}</h2>
      {/if}

      {if $use_same_address && !$cart.is_virtual}
        <p>
          {l s='The selected address will be used both as your address for invoice and as your delivery address.' d='Shop.Theme.Checkout'}
        </p>
      ...
      {elseif $customer.addresses|count > 0}
        ...
        {/if}
                ...
                <p><b>*Billing and Shipping Addresses MUST match. If a different Shipping Address is desired, please call (484) 256-2729 and we will be happy to process your order over the phone.</b></p>
