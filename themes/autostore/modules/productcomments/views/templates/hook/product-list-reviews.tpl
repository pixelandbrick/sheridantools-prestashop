...
{if $nb_comments != 0}
<div class="product-list-reviews product-list-reviews-{$product.id}" data-product-id="{$product.id}" data-comment-grade="{$product_comment_grade_url nofilter}" data-nb-comments="{$nb_comments}">
