...
{if $htmlbanners9.slides}
  <div id="htmlbanners9" class="headerslider" data-fullscreen={$htmlbanners9.fullscreen} data-autoplay={$htmlbanners9.autoplay} data-timeout="{$htmlbanners9.speed}" {*data-speed="{$htmlbanners9.slide_speed}"*} data-pause="{$htmlbanners9.pause}" data-pagination="{$htmlbanners9.pagination}" data-navigation="{$htmlbanners9.navigation}" data-loop="{$htmlbanners9.wrap}" data-anim_in="{$htmlbanners9.anim_in}" data-anim_out="{$htmlbanners9.anim_out}">
