...
<div class="row">
    <div class="col-xs-12">
        <p class="payment_module">
            <a class="bankwire" href="{$cardinal_commerce_payment_url|escape:'htmlall':'UTF-8'}" title="{l s='Pay with Cardinal Commerce' mod='cardinalcommerce'}">
                {l s='Pay with Cardinal Commerce' mod='cardinalcommerce'}
                <span>{l s='(order processing will be faster)' mod='cardinalcommerce'}</span>
                <span>
