...
class HomeFeatured extends Module
{
    ...
    public function install()
    {
        ...
        Configuration::updateValue('FEATURED_CAROUSEL', false);
        Configuration::updateValue('FEATURED_AUTOPLAY_SLI', true);
        Configuration::updateValue('FEATURED_SPEED_SLI', 5000);
        Configuration::updateValue('FEATURED_PAG_SLI', true);
        Configuration::updateValue('FEATURED_ARROWS_SLI', false);
        ...
        return parent::install() && $this->registerHook('displayBackofficeHeader') && $this->registerHook('displayHeader') && $this->registerHook('addproduct') && $this->registerHook('updateproduct') && $this->registerHook('deleteproduct') && $this->registerHook('categoryUpdate') && $this->registerHook('displayHomeTab') && $this->registerHook('displayHomeTabContent');
    }
