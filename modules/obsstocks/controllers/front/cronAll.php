...
class ObsstocksCronAllModuleFrontController extends ModuleFrontController
{
	...
	public function initContent()
	{
		...
		$datasheet = Mystocks::getDatasheetAllStock();
		$file_path = OBS_EXPORT_DIR.'current_all-stock.csv';
		...
		if(count($datasheet) > 1)
		{
			...
			$file_attachment['name'] = "current_all-stock.csv";
			$file_attachment['mime'] = "text/plain";
			
			Mail::Send(
			$id_lang,
			'available_stock',
			$this->module->l('Automatic email: All available stock'),
