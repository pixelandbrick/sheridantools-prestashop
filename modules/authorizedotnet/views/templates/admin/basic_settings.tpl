        ...
        <div class="two_columns">
            ...
            <div class="columns">
                ...
                <div class="right_column">
                    ...
                    <br/><br/>
                    <input type="radio" style="margin:-5px 0 0 0;paddin:0;border:none" name="adn_api" id="adn_api" onchange="changeAPI();" value="aim" {if $adn_api == 'aim'}checked{/if} />&nbsp; Accept Customer (Formaly AIM / CIM)
                   <br/><br/>
                    ...
                    <br />
                    <b>{l s='More information about each API can be found at' mod='authorizedotnet'} <a href="https://support.authorize.net/s/article/Authorize-Net-Integration-Methods-Explained" target="_index">https://support.authorize.net/s/article/Authorize-Net-Integration-Methods-Explained</a></b>
