...
<div class="row">
	<div class="col-lg-12">
		<div class="panel card">
			...
			<h3>
				<img src="{$base_url}modules/{$module_name}/logo.gif" alt="" />
				{l s='Authorize.net Refund Transaction' mod='authorizedotnet'}
			</h3>
			</div>
			<div class="card-body" id="refund_order_details">
			</div>
		</div>
	</div>
</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel card">
					<div class="card-header">
					<h3>
						<img src="{$base_url}modules/{$module_name}/logo.gif" alt="" /> {l s='Authorize.net Capture Transaction' mod='authorizedotnet'}
					</h3>
					<div class="card-body" id="capture_order_details">
					</div>
				</div>
			</div>
		</div>
