...
class HtmlBanners5 extends Module implements WidgetInterface
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('Testimonials on home page');
        $this->description = $this->l('Adds a testimonials on home page');
    ...
    protected function installSamples()
    {
        ...
        foreach ($languages as $language) {
            $slide->title[$language['id_lang']] = 'Ann Legetc';
            $slide->description[$language['id_lang']] = '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam feugiat nunc non risus faucibus, nec eleifend mauris rutrum. Duis porttitor aliquet nibh, non viverra est pretium ac. Cras auctor ac risus id semper. Aenean ullamcorper dui sit amet nisl ullamcorper mattis.</p>
            <p class="testimonials-author">Julia NEwman</p><p class="testimonials-object">Nissan Titan X5</p>';
            $slide->legend[$language['id_lang']] = 'Ann Legetc';
            $slide->customclass[$language['id_lang']] = 'col-12 col-md-6';
            $slide->url[$language['id_lang']] = 'https://www.prestashop.com?utm_source=back-office&utm_medium=v17_htmlbanners5'
        ...
        $slide->active = 1;
        foreach ($languages as $language) {
            $slide->title[$language['id_lang']] = 'Ivan Donsky';
            $slide->description[$language['id_lang']] = '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam feugiat nunc non risus faucibus, nec eleifend mauris rutrum. Duis porttitor aliquet nibh, non viverra est pretium ac. Cras auctor ac risus id semper. Aenean ullamcorper dui sit amet nisl ullamcorper mattis.</p><p class="testimonials-author">Ivan Donsky</p><p class="testimonials-object">Nissan Titan X5</p>';
            $slide->legend[$language['id_lang']] = 'Ivan Donsky';
            $slide->customclass[$language['id_lang']] = 'col-12 col-md-6';
            $slide->url[$language['id_lang']] = 'https://www.prestashop.com?utm_source=back-office&utm_medium=v17_htmlbanners5'
                .'&utm_campaign=back-office-'.Tools::strtoupper($this->context->language->iso_code)
                .'&utm_content='.(defined('_PS_HOST_MODE_') ? 'ondemand' : 'download');
        ...
        foreach ($languages as $language) {
            ...
            $slide->description[$language['id_lang']] = '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam feugiat nunc non risus faucibus, nec eleifend mauris rutrum. Duis porttitor aliquet nibh, non viverra est pretium ac. Cras auctor ac risus id semper. Aenean ullamcorper dui sit amet nisl ullamcorper mattis.</p><p class="testimonials-author">John Doe</p><p class="testimonials-object">Nissan Titan X5</p>';
            $slide->legend[$language['id_lang']] = 'John Doe';
            $slide->customclass[$language['id_lang']] = 'col-12 col-md-6';
            $slide->url[$language['id_lang']] = 'https://www.prestashop.com?utm_source=back-office&utm_medium=v17_htmlbanners5'
                .'&utm_campaign=back-office-'.Tools::strtoupper($this->context->language->iso_code)
                .'&utm_content='.(defined('_PS_HOST_MODE_') ? 'ondemand' : 'download');
    ...
    {
        if ($this->context->controller instanceof IndexControllerCore && Configuration::get('HTMLBANNERS5_CAROUSEL_ACTIVE') == 1) {
