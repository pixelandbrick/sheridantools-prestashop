...
{
    protected $_html = '';
    protected $default_fullscreen = 1;
    ...
    protected $default_anim_in = 22;
    protected $default_anim_out = 22;
    ...
    protected function installSamples()
    {
        ...
        foreach ($languages as $language) {
            $slide->title[$language['id_lang']] = 'Spare parts and goods for auto';
            $slide->description[$language['id_lang']] = '<div class="container">
            <div class="description">
                <p class="slide_title-one">Spare parts and goods for auto</p>
                <p>Your personal manager is an expert who will help with the selection of spare parts <br/>
and service stations</p>
                <p class="btn-box"><button class="btn fill big">Learn more</button></p>
            </div>
            </div>';
            $slide->legend[$language['id_lang']] = 'Spare parts and goods for auto';
            $slide->customclass[$language['id_lang']] = 'zoom-in-effect overlay-bg text-in-center';
        ...
        $slide->active = 1;
        foreach ($languages as $language) {
            $slide->title[$language['id_lang']] = 'Buy parts that fit your';
            $slide->description[$language['id_lang']] = '<div class="container">
            <div class="description">
                <p class="slide_title-one">Buy parts that fit your <br/>vehicle & get maintenance <br/>intervals</p>
                <p>Battery installation with purchase, check engine light code <br/>reading, battery charging, and starting system testing.</p>
                <p class="btn-box"><button class="btn fill big">Learn more</button></p>
            </div>
            </div>';
            $slide->legend[$language['id_lang']] = 'Buy parts that fit your';
            $slide->customclass[$language['id_lang']] = 'zoom-in-effect overlay-bg';
            $slide->url[$language['id_lang']] = 'https://www.prestashop.com?utm_source=back-office&utm_medium=v17_htmlbanners9'
                .'&utm_campaign=back-office-'.Tools::strtoupper($this->context->language->iso_code)
                .'&utm_content='.(defined('_PS_HOST_MODE_') ? 'ondemand' : 'download');
        ...
        $slide->active = 1;
        foreach ($languages as $language) {
            $slide->title[$language['id_lang']] = 'Buy online & pickup';
            $slide->description[$language['id_lang']] = '<div class="container">
            <div class="description">
                <p class="slide_title-one">Buy online & pickup <br/>in-store in 30 minutes</p>
                <p>Your personal manager is an expert who will help with the<br/>
selection of spare parts
and service stations</p>
                <p class="btn-box"><button class="btn fill big">Learn more</button></p>
            </div>
            </div>';
            $slide->legend[$language['id_lang']] = 'Buy online & pickup';
            $slide->customclass[$language['id_lang']] = 'zoom-in-effect overlay-bg text-in-right';
            $slide->url[$language['id_lang']] = 'https://www.prestashop.com?utm_source=back-office&utm_medium=v17_htmlbanners9'
                .'&utm_campaign=back-office-'.Tools::strtoupper($this->context->language->iso_code)
                .'&utm_content='.(defined('_PS_HOST_MODE_') ? 'ondemand' : 'download');
