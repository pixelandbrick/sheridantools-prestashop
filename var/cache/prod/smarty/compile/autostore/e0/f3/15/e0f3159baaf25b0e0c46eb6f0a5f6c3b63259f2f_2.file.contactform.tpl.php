...
/* Smarty version 4.5.5, created on 2025-09-12 23:30:20
  from '/home/sheridantools/public_html/themes/autostore/modules/contactform/views/templates/widget/contactform.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_68c4e54cc94f17_88857291',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e0f3159baaf25b0e0c46eb6f0a5f6c3b63259f2f' => 
    array (
      0 => '/home/sheridantools/public_html/themes/autostore/modules/contactform/views/templates/widget/contactform.tpl',
      1 => 1581873568,
      2 => 'file',
    ),
  ),
...
function content_68c4e54cc94f17_88857291 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
        ...
        <div class="form-group row">
          <label class="col-md-3 form-control-label"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Name','d'=>'Shop.Forms.Labels'),$_smarty_tpl ) );?>
</label>
          <div class="col-md-6">
            <input
              class="form-control"
              name="name"
              type="text"
              value="<?php echo htmlspecialchars((string) ($_smarty_tpl->tpl_vars['contact']->value['name']), ENT_QUOTES, 'UTF-8');?>
"
              placeholder=""
            >
          </div>
...
"
        ...
        <div class="form-group row">
          <label class="col-md-3 form-control-label"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Phone','d'=>'Shop.Forms.Labels'),$_smarty_tpl ) );?>
</label>
          <div class="col-md-6">
            <input
              class="form-control"
              name="phone"
              type="text"
              value="<?php echo htmlspecialchars((string) ($_smarty_tpl->tpl_vars['contact']->value['phone']), ENT_QUOTES, 'UTF-8');?>
"
              placeholder=""
            >
          </div>
         ...
         <div class="form-group row">
          <label class="col-md-3 form-control-label"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Company','d'=>'Shop.Forms.Labels'),$_smarty_tpl ) );?>
</label>
          <div class="col-md-6">
            <input
              class="form-control"
              name="company"
              type="text"
              value="<?php echo htmlspecialchars((string) ($_smarty_tpl->tpl_vars['contact']->value['company']), ENT_QUOTES, 'UTF-8');?>
"
              placeholder=""
            >
          </div>
