...
class getSupplierControllerService extends AdminKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.5V3iFzS'] ?? $container->load('get_ServiceLocator_5V3iFzSService'))->withContext('PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\SupplierController', $container));
